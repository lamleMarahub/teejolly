    ...
    posting.done(function(response) {
        ...
        if(response.success == 1){
            ...
            $.each(response.data[1], function(index,item) {
                ...
                // row += '<td><p><strong> <a href="https://www.etsy.com/listing/'+ item.listing_id + '" target="_blank">' + item.title +'('+item.variation_1 +' ; '+item.variation_2+' ; '+item.variation_3+')' +'</a></strong></p></td>'; 
